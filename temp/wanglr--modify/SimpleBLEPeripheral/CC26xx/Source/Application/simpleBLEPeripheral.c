...
{
  0xd6,0xbe,0x89,0x8e, //# Access address for advertising data Õâ¸öÍ¨³£ÊÇ¹Ì¶¨µÄ  
  0x40,// # °üÍ·µÄµÚÒ»¸ö×Ö½Ú.  Contains: (type = 0), (tx add = 1), (rx add = 0)  
  0x24,// # °üÍ·µÄµÚ¶þ¸ö×Ö½ÚµÚ£¬±íÊ¾³¤¶È£¬ÕâÀïµÄ³¤¶ÈÊÇMacµØÖ·£¨6Byte£© + Êý¾Ý°ü¹ýµÄ³¤¶È£¨ÕâÀïÊÇ30£©  
  0x05,0xa2,0x17,0x6e,0x3d,0x71,// # À¶ÑÀµÄMacµØÖ·£¬×¢ÒâÕâÀï²»ÊÇÕæÕýµÄmacµØÖ·  
  0x02,0x01,0x1a,0x1a,0xff,0x4c,0x00,0x02,0x15,0xb9,0x40,0x7f,0x30,0xf5,0xf8,0x46,0x6e,0xaf,0xf9,0x25,0x55,0x6b,0x57,0xfe,0x6d,0x00,0x01,0x00,0x01,0xc5,//<span style="font-family: Arial, Helvetica, sans-serif;"> #À¶ÑÀÊý¾Ý°ü</span>  
  0x52,0xab,0x8d,0x38,0xa5,// # Ð£ÑéºÍchecksum  
};
static uint8_t advDataiBeacon[] =
{
  0x02,// # µÚÒ»¸öAD structure µÄ×Ö½ÚÊý£¨½ÓÏÂÀ´µÄ×Ö½ÚÊý£¬ÕâÀïÊÇ2¸öbyte£©  
  0x01,// # AD type µÄ±êÖ¾  
  0x1E,// # ±êÖ¾µÄÖµ 0x1A = 000011010    
     //bit 0 (OFF) LE Limited Discoverable Mode  
     //bit 1 (ON) LE General Discoverable Mode  
     //bit 2 (OFF) BR/EDR Not Supported  
     //bit 3 (ON) Simultaneous LE and BR/EDR to Same Device Capable (controller)  
     //bit 4 (ON) Simultaneous LE and BR/EDR to Same Device Capable (Host)  
  0x1A,// # µÚ¶þ¸öAD structureµÄ×Ö½ÚÊý £¨½ÓÏÂÀ´µÄ×Ö½ÚÊý£¬ÕâÀïÊÇ26¸ö£©  
  0xFF,// # AD type µÄ±êÖ¾£¬ÕâÀïManufacturer specific data.¸ü¶àµÄ±êÖ¾¿ÉÒÔµ½BLEµÄ¹ÙÍøÕÒµ½£ºÀýÈç0x16 ±íÊ¾servicedata  
  0x4C,0x00,// # ¹«Ë¾µÄ±êÖ¾ (0x004C == Apple)  
