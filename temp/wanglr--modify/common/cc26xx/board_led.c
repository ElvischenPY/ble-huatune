...
PIN_Config ledPinsCfg[] =
{
    ...
    Board_FLASH_POWER | PIN_GPIO_OUTPUT_EN | PIN_GPIO_LOW | PIN_PUSHPULL | PIN_DRVSTR_MAX,
    Board_FLASH_WP | PIN_GPIO_OUTPUT_EN | PIN_GPIO_LOW | PIN_PUSHPULL | PIN_DRVSTR_MAX,
    Board_FLASH_HD | PIN_GPIO_OUTPUT_EN | PIN_GPIO_LOW | PIN_PUSHPULL | PIN_DRVSTR_MAX,
    PIN_TERMINATE
};
...
//  PIN_setConfig(hledPins, PIN_BM_IRQ, Board_LED4  | PIN_IRQ_DIS);
    PIN_setOutputValue(hledPins, Board_FLASH_POWER, 1);
    PIN_setOutputValue(hledPins, Board_FLASH_WP, 1);
    PIN_setOutputValue(hledPins, Board_FLASH_HD, 1);
